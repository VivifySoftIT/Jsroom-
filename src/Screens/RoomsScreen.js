...
const roomImages = {
  deluxe: 'https://images.unsplash.com/photo-1566665797739-1674de7a421a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1067&q=80',
  executive: 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?ixlib=rb-4.0.3&auto=format&fit=crop&w=1067&q=80',
  suite: 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1067&q=80',
  presidential: 'https://images.unsplash.com/photo-1590490360182-c33d57733427?ixlib=rb-4.0.3&auto=format&fit=crop&w=1067&q=80',
  family: 'https://images.unsplash.com/photo-1618773928121-c32242e63f39?ixlib=rb-4.0.3&auto=format&fit=crop&w=1067&q=80',
  standard: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1067&q=80'
};
...
const RoomsScreen = () => {
  ...
  const rooms = [
    ...
    },
    {
      ...
      rating: 4.6,
      reviews: 203,
      features: ['Connecting Rooms', 'Kids Area', 'Garden View', 'Extra Space'],
      amenities: ['Free WiFi', 'Smart TV', 'Mini Fridge', 'Room Service', 'AC', 'Coffee Machine'],
      description: 'Spacious family accommodation with connecting rooms and dedicated kids area.',
      popular: false,
      detailedAmenities: {
        popularWithGuests: ['Heater', 'Daily Housekeeping', 'Free Wi-Fi', 'Laundry Service', 'Bathroom', 'Air Conditioning', '24-hour Room Service'],
        roomFeatures: ['Charging Points', 'Chair', 'Centre Table', 'Kids Area'],
        mediaEntertainment: ['TV'],
        bathroom: ['Towels', 'Toiletries', 'Geyser/Water Heater', 'Hot & Cold Water'],
        otherFacilities: ['Newspaper']
      }
    },
    {
      ...
      rating: 4.5,
      reviews: 312,
      features: ['Comfortable Bedding', 'Modern Bathroom', 'Work Area', 'City View'],
      amenities: ['Free WiFi', 'TV', 'Mini Fridge', 'Room Service', 'AC'],
      description: 'Comfortable and well-appointed room with all essential amenities.',
      popular: false,
      detailedAmenities: {
        popularWithGuests: ['Heater', 'Daily Housekeeping', 'Free Wi-Fi', 'Bathroom', 'Air Conditioning'],
        roomFeatures: ['Charging Points', 'Chair', 'Centre Table'],
        mediaEntertainment: ['TV'],
        bathroom: ['Towels', 'Toiletries', 'Geyser/Water Heater', 'Hot & Cold Water'],
        otherFacilities: ['Newspaper']
    ...
    },
    {
      ...
      rating: 4.9,
      reviews: 94,
      features: ['Ocean View', 'Private Terrace', 'Living Room', 'Premium Amenities'],
      amenities: ['Free WiFi', 'Smart TV', 'Mini Bar', 'Room Service', 'AC', 'Coffee Machine'],
      description: 'Elegant suite with ocean views, private terrace, and separate living area.',
      popular: true,
      detailedAmenities: {
        popularWithGuests: ['Heater', 'Daily Housekeeping', 'Free Wi-Fi', 'Laundry Service', 'Bathroom', 'Air Conditioning', '24-hour Room Service'],
        roomFeatures: ['Charging Points', 'Chair', 'Centre Table', 'Living Room'],
        mediaEntertainment: ['TV'],
        bathroom: ['Towels', 'Toiletries', 'Geyser/Water Heater', 'Hot & Cold Water'],
        otherFacilities: ['Newspaper']
      }
